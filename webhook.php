...
if ($text === '/start') {
    ...
    $caption = "
    👋 **Welcome to the Potato Adventure!** 🐾🎮

    Get ready for a tail-wagging journey where every paw-tap leads to bigger rewards! Here’s what’s waiting for you:

    ✨ **Play Potato**: Tap the dog bone and watch your balance fetch amazing rewards!
    🥔 **Mine for POTATO**: Collect Potato Tokens with every action your furry friend takes.
    📋 **Complete Potato Tasks**: Help your pup finish fun missions and earn even more treats!
    🏆 **Climb the Leaderboard**: Compete with other Poatos and rise to the top to show you’re the best in the pack!
    👥 **Invite Your Pack & Earn More!**  
    Got friends, family, or fellow Potato lovers? Invite them to join the fun and grow your earnings as the pack gets bigger! The more paws, the better!
    ...
    🐾 **Get Started Now** and take your dog on the ultimate Potato adventure!
    ...
    $post_fields = [
        ...
        'reply_markup' => json_encode([
            'inline_keyboard' => [
                [
                    ['text' => 'Play Potato Now', 'web_app' => ['url' => 'https://app.companybro.com']],
